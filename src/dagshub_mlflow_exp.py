...
dagshub.init(repo_owner='imayank45', repo_name='MLflow-Experiments', mlflow=True)

# set tracking uri
mlflow.set_tracking_uri("https://dagshub.com/imayank45/MLflow-Experiments.mlflow")
...
with mlflow.start_run():
    ...
    # set tags
    mlflow.set_tags({"Author": "Mayank", "Project": "Wine Quality Classification"})
